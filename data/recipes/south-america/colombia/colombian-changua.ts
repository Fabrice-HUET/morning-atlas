...
export const colombianChanguaRecipe = {
  ...
  reviewNotes: [
    ...
    'Le chocolat chaud peut accompagner certains contextes, sans être systématique.',
  ],
  sources: [
    {
